                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <h4 class="mt-3">Danh Sách Hoá Đơn Bán Hàng</h4>
                        </div>
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle" colspan="3">Tổng Tiền: VNĐ</th>
                            </tr>
                            <tr>
                                <th class="text-center align-middle">#</th>
                                <th class="text-center align-middle">Mã Hoá Đơn</th>
                                <th class="text-center align-middle">Nhân Viên Thanh Toán</th>
                                <th class="text-center align-middle">Tiền Trước Giảm</th>
                                <th class="text-center align-middle">Phần Trăm Giảm</th>
                                <th class="text-center align-middle">Tổng Tiền Đã Giảm</th>
                                <th class="text-center align-middle">Ghi Chú</th>
                                <th class="text-center align-middle">Chi Tiết Hoá Đơn</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle text-center"></td>
                                <td class="align-middle text-center"></td>
                                <td class="align-middle text-center"><i class="fa-solid fa-comment fa-2x"></i></td>
                                <td class="align-middle text-center"><i class="fa-solid fa-circle-info fa-2x" style="color: #17A3FF;"></i></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
