          ...
          <div class="user-box dropdown">
            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button"
              ...
              <div class="user-info ps-3">
                <p class="user-name mb-0">Người Dùng</p>
        ...
        <ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <router-link to="/admin/quan-ly-san-pham/san-pham">
                  <a class="dropdown-item" href="/admin/quan-ly-san-pham/san-pham"><i class="bx bx-right-arrow-alt"></i>Sản Phẩm</a>
                </router-link>
              </li>
              <li>
                <router-link to="/admin/quan-ly-san-pham/danh-muc-san-pham">
                  <a class="dropdown-item" href="/admin/quan-ly-san-pham/danh-muc-san-pham"><i class="bx bx-right-arrow-alt"></i>Danh Mục
                    Sản Phẩm</a>
                </router-link>
              </li>
            </ul>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <router-link to="/admin/quan-ly-nhap-kho/nhap-kho">
                  <a class="dropdown-item" href="/admin/quan-ly-nhap-kho/nhap-kho"><i class="bx bx-right-arrow-alt"></i>Nhập Kho</a>
                </router-link>
              </li>
              <li>
                <router-link to="/admin/quan-ly-nhap-kho/hoa-don-nhap-kho">
                  <a class="dropdown-item" href="/admin/quan-ly-nhap-kho/hoa-don-nhap-kho"><i class="bx bx-right-arrow-alt"></i>Hoá Đơn Nhập Kho</a>
                </router-link>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <router-link to="/admin/quan-ly-ban-hang/dich-vu">
                  <a class="dropdown-item" href="/admin/quan-ly-ban-hang/dich-vu"><i class="bx bx-right-arrow-alt"></i>Sử Dụng Dịch Vụ</a>
                </router-link>
              </li>
              <li>
                <router-link to="/admin/quan-ly-ban-hang/hoa-don-ban-hang">
                  <a class="dropdown-item" href="/admin/quan-ly-ban-hang/hoa-don-ban-hang"><i class="bx bx-right-arrow-alt"></i> Danh Sách Hoá Đơn Bán Hàng</a>
                </router-link>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <router-link to="/admin/quan-ly-nhan-su/chuc-vu">
                  <a class="dropdown-item" href="/admin/quan-ly-nhan-su/chuc-vu"><i class="bx bx-right-arrow-alt"></i>Chức Vụ</a>
                </router-link>
              </li>
              <li>
                <router-link to="/admin/quan-ly-nhan-su/nhan-vien">
                  <a class="dropdown-item" href="/admin/quan-ly-nhan-su/nhan-vien"><i class="bx bx-right-arrow-alt"></i>Nhân Viên</a>
                </router-link>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            <router-link to="/admin/nha-cung-cap">
              <a class="nav-link" href="/admin/nha-cung-cap">
                <div class="parent-icon"><i class="fa-solid fa-motorcycle"></i></div>
